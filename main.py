import random
from functions import * # Add all functions to "functions.py" to make code cleaner and organized (12/05/23)
...
while True:
    choice = input("Who do you want to fight (Computer or Player?)")
    if choice == "Player":
        # Initialize player variables and takes their symbols 
        playerOne = input("Choose your symbol (P1):")
        playerTwo = input("Choose your symbol (P2):")
    elif choice == "Computer":
